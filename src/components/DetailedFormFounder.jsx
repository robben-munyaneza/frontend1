  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      <div className="w-2/3 p-8 bg-white shadow-lg">
        ...
        <h2 className='mb-2 font-light text-2xl'>Founder info:</h2>
        <form onSubmit={handleSubmit} className="space-y-1">
          <div className="grid grid-cols-1 gap-1">
            ...
            <label htmlFor="block text-sm font-medium text-gray-700">Date of birth on the item:</label>
            <input
              type="date"
              name="dateOfBirth"
          ...
          />
            ...
            <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-red-500 transition-colors duration-200">
                  ...
                  <>
                    <div className="flex flex-col items-center">
                      ...
                      <div className="flex text-sm text-gray-600">
                        <label
                          htmlFor="file-upload"
                          className="relative cursor-pointer bg-white rounded-md font-medium text-red-600 hover:text-red-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500"
                        >
        ...
        <div className="text-center mt-16">
          ...
          <div className="space-y-4">
            <div className="bg-white p-4 rounded-lg shadow-md">
              <h3 className="font-semibold text-red-700">Gukurikirana Aho Biri(Geolocation Tracking)</h3>
              <p className="text-gray-600">Serivisi z’iterambere z’aho dokima ziri kugira ngo zifashe mu gushakisha.</p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow-md">
              <h3 className="font-semibold text-red-700">Ibigenga by' Amakuru(Comprehensive Databases)</h3>
